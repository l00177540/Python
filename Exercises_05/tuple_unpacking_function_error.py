...
print(product, price)
# Error with the changed penultimate line is: ValueError: not enough values to unpack (expected 3, got 2)
# The reason for the error is the variable 'availability' has not been defined
